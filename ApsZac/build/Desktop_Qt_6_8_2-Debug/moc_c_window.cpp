...
namespace {
struct qt_meta_tag_ZN8C_windowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8C_windowE = QtMocHelpers::stringData(
    "C_window",
    "cel_created",
    "",
    "Cel",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8C_windowE[] = {
...
Q_CONSTINIT const QMetaObject C_window::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8C_windowE.offsetsAndSizes,
    qt_meta_data_ZN8C_windowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8C_windowE_t,
        // Q_OBJECT / Q_GADGET
...
void *C_window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8C_windowE.stringdata0))
