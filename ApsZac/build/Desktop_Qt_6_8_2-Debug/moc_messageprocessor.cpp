...
static constexpr auto qt_meta_stringdata_ZN16MessageProcessorE = QtMocHelpers::stringData(
    "MessageProcessor",
    "message_ready",
    "",
    "device_data_ready",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16MessageProcessorE[] = {
...
Q_CONSTINIT const QMetaObject MessageProcessor::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16MessageProcessorE.offsetsAndSizes,
    qt_meta_data_ZN16MessageProcessorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16MessageProcessorE_t,
        // Q_OBJECT / Q_GADGET
...
void *MessageProcessor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16MessageProcessorE.stringdata0))
