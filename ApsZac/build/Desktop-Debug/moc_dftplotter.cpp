...
namespace {
struct qt_meta_stringdata_DftPlotter_t {
    uint offsetsAndSizes[2];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_DftPlotter_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_DftPlotter_t qt_meta_stringdata_DftPlotter = {
    {
        QT_MOC_LITERAL(0, 10)   // "DftPlotter"
    },
    "DftPlotter"
};
...
Q_CONSTINIT static const uint qt_meta_data_DftPlotter[] = {
...
Q_CONSTINIT const QMetaObject DftPlotter::staticMetaObject = { {
    ...
    qt_meta_stringdata_DftPlotter.offsetsAndSizes,
    qt_meta_data_DftPlotter,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_DftPlotter_t,
        // Q_OBJECT / Q_GADGET
...
void *DftPlotter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DftPlotter.stringdata0))
